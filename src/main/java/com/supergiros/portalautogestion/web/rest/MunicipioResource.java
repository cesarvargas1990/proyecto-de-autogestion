...
/**
 * REST controller for managing {@link com.supergiros.portalautogestion.domain.Municipio}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Municipio> partialUpdateMunicipio(
        ...
        Optional<Municipio> result = municipioRepository
            ...
            .map(existingMunicipio -> {
                ...
                if (municipio.getCodDane() != null) {
                    existingMunicipio.setCodDane(municipio.getCodDane());
                }
                if (municipio.getfKIdDepartamento() != null) {
                    existingMunicipio.setfKIdDepartamento(municipio.getfKIdDepartamento());
                }
